...
/* 0x00000114 */
static char *GetEndOfString(char *string)
{ // Returns a pointer to the end of the string. A whitespace character will also be considered as a end-of-string marker.
    while (*string != NULL) {
